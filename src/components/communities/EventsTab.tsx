              ...
              return (
                <div
                  ...
                  className={`group rounded-lg border p-4 transition-shadow hover:shadow-sm ${
                    isPast
                      ? "border-charcoal-100 bg-charcoal-50/50 dark:border-charcoal-700 dark:bg-charcoal-800/30"
                      : "border-charcoal-100 bg-white dark:border-charcoal-700 dark:bg-charcoal-800/60"
                  }`}
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-1.5 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-charcoal-400 dark:text-charcoal-400">
